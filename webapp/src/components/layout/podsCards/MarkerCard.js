		...
		<div className="card my-2 mx-2 " style={{ width: "95%" }}>
			...
			<div className="card-body">
				...
				{marker.id !== "" && marker.id !== undefined && (
					<div className="mt-2 ratings">{t("MarkerCard.rating")} {stars}</div>
				)}
			</div>
			...
			<ul className="list-group list-group-flush">
				<li className="list-group-item">{t("MarkerCard.lat")} {marker.coords.lat}</li>
				<li className="list-group-item">{t("MarkerCard.long")} {marker.coords.lng}</li>
			</ul>
			{marker.id !== "" && marker.id !== undefined && (
				<>
							...
							<div key={i} className="card mb-2">
								<div className="mx-2 my-2">
									...
									<p className="card-text" style={{ fontSize: "0.7rem" }}>
										...
										{t("MarkerCard.inComm.on")} {new Date(comment.date).toDateString()}
									</p>
								</div>
							</div>
						);
