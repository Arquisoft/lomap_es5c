...
****
Here, the app is represented as a whitebox. Inside of it we can see components based architecture convention in black boxes:
...
image::Whitebox_Overall_System.png[] 

==== Black Box descriptions of Overall System

|=======================
|Name|Responsability
|**Model**| Stores/gets data from/to database and gets info from personal pods. Defines business model and also gives information to the view layer to represent it.
