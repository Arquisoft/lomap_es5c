...
Ahora cuando lancemos la API en [http://localhost:5001/metrics](http://localhost:5001/metrics) tendremos un endpoint de metricas con datos de desempeño. La idea es tener otra pieza de software corriendo (llamada [Prometheus](https://prometheus.io/)) que cogerá estos datos, digamos, cada cinco segundos. a continuación otro software llamado [Grafana](https://grafana.com/) los mostrará con graficos chulos.
...
ab -m GET -n 10000 -c 100 http://localhost:5001/api/users/list
```
